          ...
          <div className="aboutPage">
            <center>
              ...
              >
                ...
                information and care, enabling them to make better life
                decisions.
              </h6>
              <div className="bg-image-inspire">
                ...
                >
                  ...
                  <p>
                    It is the journey that takes you to new destinations every
                    day with endless possibilities of life on the back of
                    happiness, energy, and hope. Vcare4u wants to make this
                    journey easy for every Indian and help them live easier and
                    longer lives.
                  </p>
                </div>
              </div>
              ...
              <div>
                <h1>
                  Each time a person finds the right consultant, we build a
                  better nation
                </h1>
                <Row>
                  <Col sm={4}>
